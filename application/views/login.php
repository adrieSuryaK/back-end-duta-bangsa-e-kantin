...
<head>
  ...
  <link href="<?php echo base_url();?>dist/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
</head>
<body class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url();?>"><b>Paguyuban</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    ...
    <!-- /.login-card-body --><br><br><br><br><br><br>
  </div>
</div>
<!-- /.login-box -->
